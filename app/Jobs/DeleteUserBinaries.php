 ...
 * their photos, voice notes and videos would otherwise be orphaned on S3 forever
 * — a GDPR erasure gap and an unbounded storage leak (the retention purge only
...
class DeleteUserBinaries implements ShouldQueue
{
     ...
     * Every kind that service can write MUST appear here, or that kind survives
     * the user's own deletion request.
     */
    private const KINDS = ['attachments', 'audio', 'videos', 'character-photos'];
